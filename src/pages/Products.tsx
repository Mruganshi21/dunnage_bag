...
import twoPlyImage from '../assets/2ply_Paper_bag.jpg';
  ...
  const categories = [
    {
      ...
      image: plasticImage,
      products: [
        { name: 'Regular', image: plasticImage, features: ['Air-cushioned protection', 'Reusable', 'Water-resistant'], benefits: ['Prevents scratches', 'Lightweight', 'Adjustable'], subOptions: ['Small bubbles', 'Large bubbles', 'Anti-static'] },
        { name: 'Gazzeted', image: gazzated, features: ['Inflatable', 'Lightweight', 'Reusable'], benefits: ['Fills voids', 'Cost effective', 'Quick to use'], subOptions: ['Small', 'Medium', 'Large'] },
    ...
    },
    {
      ...
      image: paperImage,
      products: [
        { name: 'Laminated Paper', image: twoPlyImage, features: ['100% recyclable', 'Biodegradable', 'Strong cushioning'], benefits: ['Eco-friendly', 'Cost effective', 'Static-free'], subOptions: ['Standard Weight'] },
    ...
    },
    {
      ...
      image: toolsImage1,
      products: [
        { name: 'Pneumatic Air Inflator Tool', image: toolsImage2, features: ['Quick sealing', 'Consistent', 'Reliable'], benefits: ['Secure closure', 'Time saving', 'Clean finish'], subOptions: ['Handheld', 'Desktop'] },
         { name: 'Electric Blower With Attachment', image: toolsImage3, features: ['Easy to use', 'Adjustable', 'Durable'], benefits: ['Faster packing', 'Less waste', 'Professional'], subOptions: ['Manual', 'Auto-cut'] },
        { name: ' Battery Operated Blower With Attachment', image: toolsImage1, features: ['Easy to use', 'Adjustable', 'Durable'], benefits: ['Faster packing', 'Less waste', 'Professional'], subOptions: ['Manual', 'Auto-cut'] },
      ]
    }
  ];
